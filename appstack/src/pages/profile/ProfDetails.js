...
import { Button, Card, CardBody, CardHeader, CardTitle, FormGroup, Label, Input, Modal, ModalBody, ModalFooter } from "reactstrap";
...
class ProfDetails extends Component {
    constructor(props) {
        ...
        this.isChangeValueUpdate = this.isChangeValueUpdate.bind(this)
    }
    updateUser() {
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    <ModalBody>
                        ...
                        <FormGroup>
                            ...
                            <Input type="text" id="fullname" name="changeFullname" defaultValue={this.state.fullname} onChange={this.isChangeValueUpdate} required />
                        ...
                        <FormGroup>
                            ...
                            <Input type="select" id="gender" name="changeGender" defaultValue={this.state.gender}  onChange={this.isChangeValueUpdate}>
                                <option>Male</option>
                        ...
                        <FormGroup>
                            ...
                            <Input type="tel" id="phone_number" name="changePhone_number" defaultValue={this.state.phone_number}  onChange={this.isChangeValueUpdate} />
                        </FormGroup>
